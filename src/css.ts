...
header{display:flex;flex-wrap:wrap;gap:.5rem 1.25rem;align-items:baseline;padding:1.1rem 0 .7rem}
...
main{position:relative;margin:.75rem 0;padding:2rem 1.75rem 2.25rem}
