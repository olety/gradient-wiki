...
const LATER_COLUMNS: Record<string, Record<string, string>> = {
  ...
  revisions: { undo_hash: "TEXT", undo_expires: "INTEGER", redacted_at: "INTEGER", sealed: "INTEGER NOT NULL DEFAULT 0", flag_cat: "INTEGER", flag_quote: "TEXT", flag_model: "TEXT", flag_at: "INTEGER", kept_body: "TEXT" },
  rows: { undo_hash: "TEXT", undo_expires: "INTEGER", redacted_at: "INTEGER", sealed: "INTEGER NOT NULL DEFAULT 0", flag_cat: "INTEGER", flag_quote: "TEXT", flag_model: "TEXT", flag_at: "INTEGER", kept_body: "TEXT" },
};
