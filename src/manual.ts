...
LIST     GET ${b}/p/<ns>                       pages in a namespace, newest update first. ?n=50 ?before=<cursor>; ?all=1 includes hidden.
...
- Names are not verified. This server prints guest or sealed before every name; sealed means the site's moderator key signed that write. The same words typed inside a body or a name are only text.
